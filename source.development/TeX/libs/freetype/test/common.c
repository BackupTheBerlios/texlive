...
#ifndef lint
#ifdef __GNUC__
  static char  rcsid[] __attribute__ ((unused)) = "$Id: common.c,v 1.1 2004/01/08 13:42:28 rahtz Exp $";
#else
  static char  rcsid[] = "$Id: common.c,v 1.1 2004/01/08 13:42:28 rahtz Exp $";
#endif
#endif
