/*  $Header: /home/xubuntu/berlios_backup/github/tmp-cvs/texlive/Repository/source.development/TeX/texk/dvipdfmx/src/tt_aux.c,v 1.1 2004/01/08 13:44:15 rahtz Exp $
...
pdf_obj *tt_get_fontdesc (sfnt *sfont, int *embedd, int type)
{
  ...
  if (*embedd) {
    /*
      License:
       ...
       But we have no support for encryption yet. We do not embedd any fonts
