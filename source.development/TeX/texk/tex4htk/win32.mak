...
# Time-stamp: <03/08/23 17:02:03 popineau>
#
################################################################################
root_srcdir = ..\..
...
installdirs = $(texmf)\tex4ht\base $(prefix)\setupw32
...
#	$(copy) .\tex4ht.env $(texmf)\tex4ht\base
	$(copy) tex4ht.imagick $(prefix)\setupw32
	$(copy) tex4ht.imagick $(texmf)\tex4ht\base
	$(copy) tex4ht.netpbm $(prefix)\setupw32
	$(copy) tex4ht.netpbm $(texmf)\tex4ht\base
