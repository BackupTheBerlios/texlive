...
# Time-stamp: <04/01/04 23:10:45 popineau>
#
################################################################################
...
#
PATH = c:\program files\Intel\compiler45\bin;$(PATH)
CC = $(silent)icl
LIB=C:\Program Files\Intel\compiler45\lib;$(LIB)
CCLD = $(silent)xilink
!else
#
...
# Compilation flags.
!ifdef NODEBUG
optflags = -O2x -G6 -Gr -Gy -GL # -QaxiK -Qipo_obj -Qunroll # Intel specific
!ELSE
optflags = -Od -G6r -Zi
...
!ifdef NODEBUG
ldebug = /RELEASE /LTCG /OPT:REF /VERSION:$(major_version_number).$(minor_version_number)
!ELSE
...
PATH = $(bindir);$(bindir:-static=);$(kpathseadir)\$(objdir);.\$(objdir);$(PATH)
